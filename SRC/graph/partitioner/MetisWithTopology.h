...
// $Source: /usr/local/cvs/OpenSees/SRC/graph/partitioner/MetisWithTopology.h,v $
...
//
// What: "@(#) MetisWithTopology.h, revA"

#ifndef MetisWithTopology_h
#define MetisWithTopology_h
...
class MetisWithTopology : public GraphPartitioner, public GraphNumberer
{
  public:
    MetisWithTopology(int numParts =1);
    MetisWithTopology(int Ptype, 
	  int Mtype, 
	  int coarsenTo,
	  int Rtype, 
	  int IPtype,
